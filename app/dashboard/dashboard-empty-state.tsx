...
export const DashboardEmptyState = () => {
  ...
  const { mutate: insertQuickstartCategories, isPending } =
    trpc.category.insertQuickstartCategories.useMutation({
      onSuccess: () => {
        utils.category.getEventCategories.invalidate();
      },
      onError: (error) => {
        console.error("Failed to create quickstart event category:", error);
      },
    });
